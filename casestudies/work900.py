...
class Work900(WorkTemplate):
    '''

    2020-12-10
    To debug SAC algorithm, learn agents with gamma = 1 and nIntervalUpdateValuefunction = infinity, which means skip updating state value function.
    Then, here, examines only action value function and policy updates.
