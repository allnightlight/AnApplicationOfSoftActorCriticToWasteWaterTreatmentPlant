...
class Work903(WorkTemplate):
    '''

    2020-12-10
    
    This configuration is a variant of work902.
    The difference is 
        alphaTemp(weight on Entropy) is set a large number such as 1e+2 or 1e+3
        in order to examine turning the standard deviation of the agent's policy
    ...
    def generateBuildParameter(self):
        ...
        for _ in range(self.nAgent):
            ...
            yield ConcreteBuildParameter(nIntervalSave = nEpoch//2
                                            ...
                                            , discountFactor = 1.
                                            , alphaTemp = float(np.random.choice([1e+2, 1e+3]))
